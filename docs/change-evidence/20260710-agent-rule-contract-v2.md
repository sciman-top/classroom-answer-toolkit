# 20260710 Agent Rule Contract v2 - classroom-answer-toolkit
...
## Verification
- `python D:\CODE\governed-ai-coding-runtime\scripts\verify-target-project-rules.py --targets classroom-answer-toolkit --require-all`
...
- 工作树边界：本轮前工作树无无关改动；setup/bootstrap 未执行。
