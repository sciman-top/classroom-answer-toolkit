...
switch ($Action) {
    "materialize" { & $python (Join-Path $PSScriptRoot "visual_machine_review.py") --materialize-fixtures }
    "validate" { & $python (Join-Path $PSScriptRoot "visual_machine_review.py") --validate-fixtures }
