...
switch ($Action) {
    "materialize" { & $python (Join-Path $PSScriptRoot "visual_ocr_region_association.py") --materialize-fixtures }
    "validate" { & $python (Join-Path $PSScriptRoot "visual_ocr_region_association.py") --validate-fixtures }
