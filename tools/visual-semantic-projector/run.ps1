...
switch ($Action) {
    "materialize" { & $python (Join-Path $PSScriptRoot "visual_semantic_projector.py") --materialize-fixtures }
    "validate" { & $python (Join-Path $PSScriptRoot "visual_semantic_projector.py") --validate-fixtures }
