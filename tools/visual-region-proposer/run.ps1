...
switch ($Action) {
    "materialize" { & $python (Join-Path $PSScriptRoot "visual_region_proposer.py") --materialize-fixtures }
    "validate" { & $python (Join-Path $PSScriptRoot "visual_region_proposer.py") --validate-fixtures }
