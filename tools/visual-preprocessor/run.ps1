...
switch ($Action) {
    "materialize" { & $python (Join-Path $PSScriptRoot "visual_preprocessor.py") --materialize-fixtures }
    "validate" { & $python (Join-Path $PSScriptRoot "visual_preprocessor.py") --validate-fixtures }
