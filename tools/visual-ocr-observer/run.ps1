...
switch ($Action) {
    "materialize" { & $python (Join-Path $PSScriptRoot "visual_ocr_observer.py") --materialize-fixtures }
    "validate" { & $python (Join-Path $PSScriptRoot "visual_ocr_observer.py") --validate-fixtures }
