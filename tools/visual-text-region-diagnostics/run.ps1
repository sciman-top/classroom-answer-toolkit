...
switch ($Action) {
    "materialize" { & $python (Join-Path $PSScriptRoot "visual_text_region_diagnostics.py") --materialize-fixtures }
    "validate" { & $python (Join-Path $PSScriptRoot "visual_text_region_diagnostics.py") --validate-fixtures }
