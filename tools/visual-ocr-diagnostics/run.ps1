...
switch ($Action) {
    "materialize" { & $python (Join-Path $PSScriptRoot "visual_ocr_diagnostics.py") --materialize-fixtures }
    "validate" { & $python (Join-Path $PSScriptRoot "visual_ocr_diagnostics.py") --validate-fixtures }
