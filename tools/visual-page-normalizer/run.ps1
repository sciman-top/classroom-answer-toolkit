...
switch ($Action) {
    "materialize" { & $python (Join-Path $PSScriptRoot "visual_page_normalizer.py") --materialize-fixtures }
    "validate" { & $python (Join-Path $PSScriptRoot "visual_page_normalizer.py") --validate-fixtures }
