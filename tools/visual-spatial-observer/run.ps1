...
switch ($Action) {
    "materialize" { & $python (Join-Path $PSScriptRoot "visual_spatial_observer.py") --materialize-fixtures }
    "validate" { & $python (Join-Path $PSScriptRoot "visual_spatial_observer.py") --validate-fixtures }
