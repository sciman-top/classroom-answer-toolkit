...
This directory stores fixed regression assets for the `senior-physics-answer` prompt and
render workflow.
...
- experimental controlled-graphic placement sample for marker-based figure insertion and delivery validation
