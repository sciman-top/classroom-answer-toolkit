# Junior Physics Answer Prompt Assets

`prompts/junior-physics-answer/` is the canonical prompt-asset root for the junior-high
physics answer workflow.

## Current baseline

- Human-readable production spec: `../specs/compiled/试卷参考答案交付规范-初中物理-完整版-v8.14.md`
...
- Fixed regression/eval dataset: `../../eval/junior-physics-answer/`
...
- prompt policy lives under `prompts/junior-physics-answer/`
- eval fixtures and visual baselines live under `eval/junior-physics-answer/`
